...
--------------------------------------------------------------------
$user> git archive --prefix=svpgm2txt-1.2/ v1.2 | gzip > svpgm2txt-1.2.tar.gz
--------------------------------------------------------------------
...
it and rename it to svpgm2txt_1.2.orig.tar.gz.
...
--------------------------------------------------------------------
$user> git archive --prefix=svpgm2txt-1.2/ v1.2 | gzip > YOUR_LOCATION/svpgm2txt_1.2.orig.tar.gz
--------------------------------------------------------------------

Go to your directory and extract svpgm2txt_1.2.orig.tar.gz with and go in the directory.

--------------------------------------------------------------------
$user> tar -xvzf svpgm2txt_1.2.orig.tar.gz
$user> cd svpgm2txt-1.2
--------------------------------------------------------------------

Now go to the  svpgm2txt-1.2 directory and move the packaging/ubuntu into debian :
...
--------------------------------------------------------------------
#root> ebuild svpgm2txt-1.2.ebuild digest
--------------------------------------------------------------------

Now you can test the build steps one by one :

--------------------------------------------------------------------
#root> ebuild svpgm2txt-1.2.ebuild clean
#root> ebuild svpgm2txt-1.2.ebuild fetch
#root> ebuild svpgm2txt-1.2.ebuild unpack
#root> ebuild svpgm2txt-1.2.ebuild prepare
#root> ebuild svpgm2txt-1.2.ebuild configure
#root> ebuild svpgm2txt-1.2.ebuild compile
#root> ebuild svpgm2txt-1.2.ebuild test
--------------------------------------------------------------------
...
--------------------------------------------------------------------
#root> echo "=app-text/svpgm2txt-1.2" >> /etc/portage/package.keywords
...
--------------------------------------------------------------------
$user> git archive --prefix=svpgm2txt-1.2/ v1.2 | gzip > YOUR_LOCATION/svpgm2txt-1.2.tar.gz
--------------------------------------------------------------------
...
--------------------------------------------------------------------
$user> cp YOUR_LOCATION/svpgm2txt-1.2.tar.gz ~/rpmbuild/SOURCES
